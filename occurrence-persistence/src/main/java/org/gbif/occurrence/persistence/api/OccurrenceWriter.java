...
/**
 * An interface to govern the updating and deleting of Occurrences. There is no insert because an
 * Occurrence must always first exist as a Fragment, thereby having an assigned key. With the key
 * any changes to the record are therefore updates.
 */
public interface OccurrenceWriter {

  /**
   * Updates an existing occurrence. If the key field of the occurrence is null an
  ...
  /**
   * Deletes the occurrence having the given key. Returns the deleted occurrence, or null if the
