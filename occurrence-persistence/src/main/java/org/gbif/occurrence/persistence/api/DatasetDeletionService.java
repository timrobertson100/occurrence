...
/**
 * Describes a service dedicated to the sole purpose of deleting all occurrences for an entire
 * dataset.
 */
public interface DatasetDeletionService {

  /**
   * Deletes the occurrences of the indicated dataset as well as any secondary indexes that may be
   * based on them.
   *
