...
public class OccurrenceSearchFieldsDefinition {
  ...
  private static final Set<String> NON_SEARCHABLE_HIVE_TYPES = ImmutableSet.<String>of(HiveDataTypes.TYPE_BIGINT,
      HiveDataTypes.TYPE_ARRAY_STRING, HiveDataTypes.TYPE_INT, HiveDataTypes.TYPE_BOOLEAN);
  ...
  private static final Set<Term> SEARCH_FIELDS = Sets.difference(
      Sets.filter(DownloadTerms.DOWNLOAD_INTERPRETED_TERMS_HDFS, NON_SEARCHABLE_TYPES), FullTextFieldBuilder.NON_FULL_TEXT_TERMS);
