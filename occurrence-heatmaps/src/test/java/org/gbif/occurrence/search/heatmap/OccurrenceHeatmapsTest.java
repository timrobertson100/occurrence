...
public class OccurrenceHeatmapsTest {
  ...
  public void heatmapRequestBuildTest() {
    ...
    OccurrenceHeatmapRequest heatmapRequest = OccurrenceHeatmapRequestProvider.buildOccurrenceHeatmapRequest(getMockRequest());
  ...
  private static HttpServletRequest getMockRequest() {
    ...
    when(servletRequest.getParameter(OccurrenceHeatmapRequestProvider.PARAM_QUERY_STRING)).thenReturn(Q);
  ...
  private static QueryResponse getMockQueryResponse() {
    ...
    coordinateHeatmap.add("counts_ints2D", Arrays.asList(Arrays.asList(1, 2, 3, 4), Arrays.asList(1, 2, 3, 4)));
  ...
  public void heatmapResponseBuilderTest() {
    OccurrenceHeatmapResponse heatmapSearchResponse =
        OccurrenceHeatmapResponseBuilder.build(getMockQueryResponse(), OccurrenceSolrField.COORDINATE.getFieldName());
