...
/**
 * A field within the definition encapsulates the information linking the Hive field, the HBase
 * column, the Term in the enumeration and the type for the Hive table.
 */
@Immutable
