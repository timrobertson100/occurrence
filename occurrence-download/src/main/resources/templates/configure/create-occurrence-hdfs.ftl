...
--Synchronizing table swapping with occurrence-download to guarantee correct occurrence's in download everytime.
...
UNLOCK TABLE uat.occurrence_hdfs;
UNLOCK TABLE uat.occurrence_multimedia;
