...
public class DownloadDwcaActor extends UntypedActor {
  ...
  private static void writeMediaObjects(ICsvBeanWriter multimediaCsvWriter, org.apache.hadoop.hbase.client.Result result,
    ...
    if (multimedia != null) {
      for (MediaObject mediaObject : multimedia) {
        multimediaCsvWriter.write(new InnerMediaObject(mediaObject, occurrenceKey), MULTIMEDIA_COLUMNS, MEDIA_CELL_PROCESSORS);
      }
    }
  }
  ...
  /**
   * Inner class used to export data into multimedia.txt files. The structure must match the headers
   * defined in MULTIMEDIA_COLUMNS.
   */
  public static class InnerMediaObject extends MediaObject {
    ...
    /**
     * Default constructor. Required by CVS serialization.
     */
    ...
    /**
     * Default constructor. Copies the fields of the media object parameter and assigns the coreid.
     */
  ...
  /**
   * Produces a String instance clean of delimiter. If the value is null an empty string is returned.
   */
