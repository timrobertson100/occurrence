...
/**
 * 
 * Oozie action persists meta information of download to registry. It currently support species list
 * and sql download.
 *
 */
public class DownloadMetaPersistence {
  ...
  public static void main(String[] args) throws IOException {
    ...
    CitationsFileReader.readCitationsAndUpdateLicense(nameNode, citationPath,
        new CitationsFileReader.PersistUsage(downloadKey, registryWsURL));
