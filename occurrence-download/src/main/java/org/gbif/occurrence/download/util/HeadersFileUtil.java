...
/**
 * Utility class that generates a headers file for occurrence downloads. Header columns in general
 * use the simple name of a term.
 */
public class HeadersFileUtil {
  ...
  /**
   * Creates the headers file. The output file name can be specified as argument. If the file names
   * are not specified the files are generated in the current directory with the name
   * "verbatim_headers.txt" and "verbatim_headers.txt".
   */
  public static void generateHeadersFiles(String verbatimFileName, String interpretedFileName, String multimediaFileName)
      throws IOException {
  ...
  public static void main(String[] args) throws IOException {
    if (args.length < 3) {
      throw new IllegalArgumentException("3 Parameters are required: verbatim, interpreted and multimedia header file names");
    }
