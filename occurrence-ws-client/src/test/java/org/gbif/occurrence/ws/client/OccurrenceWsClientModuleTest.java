...
public class OccurrenceWsClientModuleTest {
  ...
  public void testCreate() throws Exception {
    ...
    // props.setProperty("occurrencedownload.ws.url",
    // "http://jawa.gbif.org:8080/occurrence-download-ws/");
    ...
    DownloadRequest d = new PredicateDownloadRequest(new EqualsPredicate(OccurrenceSearchParameter.TAXON_KEY, "5219426"), USER, null, true,
        DownloadFormat.DWCA);
