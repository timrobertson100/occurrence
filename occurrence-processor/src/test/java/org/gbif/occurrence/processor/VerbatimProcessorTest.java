...
public class VerbatimProcessorTest {
  ...
  private static final ConnectionParameters CONNECTION_PARAMETERS = new ConnectionParameters("localhost", 5672, "guest", "guest", "/");
  ...
  public void setUp() throws Exception {
    ...
    Fragment fragment = new Fragment(DATASET_KEY, json.getBytes(Charsets.UTF_8), json.getBytes(Charsets.UTF_8), Fragment.FragmentType.JSON,
        EndpointType.DWC_ARCHIVE, new Date(), 1, null, null, new Date().getTime());
  ...
  public void generateVerbFromFrag() throws IOException, InterruptedException {
    messagePublisher.send(new FragmentPersistedMessage(UUID.fromString("85697f04-f762-11e1-a439-00145eb45e9a"), 1, NEW, 1));
    Thread.sleep(5000);
